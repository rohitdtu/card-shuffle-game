...
export default class Cards extends Component {
  ...
  // checks if 2 flipped cards have same value
  check() {
    let finalizedData = this.state.finalizedData;
    if (
 ...
 // creates an array of closed cards(not flipped).
  ...
  // renders the cards of right deck
  render() {
    return (
      <div className="col-lg-6">
        <div className="col-lg-12">DECK B</div>
        <div className="RightDeck col-lg-12">
